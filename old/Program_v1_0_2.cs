...
namespace TermWrap
{
    internal static class Program
    {
        ...
        {
            Console.WriteLine("termwrap.exe start [session] [--protocol ssh|telnet|auto] [--user USER] [--password PASSWORD] [--port PORT] [--login-prompt TEXT] [--password-prompt TEXT] host[:port] [ssh-args...]");
